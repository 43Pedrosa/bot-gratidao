...
# Lista original de símbolos desejados
SYMBOLS_ORIGINAIS = [
...
# Buscar mercados disponíveis na Bybit
def filtrar_simbolos_validos(lista):
    mercados = EXCHANGE.load_markets()
    return [s for s in lista if s in mercados]

SYMBOLS = filtrar_simbolos_validos(SYMBOLS_ORIGINAIS)
print("✅ Símbolos válidos:", SYMBOLS)
...
print("🤖 Scanner ZUERAI v2.1 com filtro de símbolos iniciado...")
while True:
